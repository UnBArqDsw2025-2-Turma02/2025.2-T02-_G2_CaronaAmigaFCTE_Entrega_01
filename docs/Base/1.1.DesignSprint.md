...
<details style="margin-bottom: 20px;">
    ...
    <p style="text-align:center;"><b>Fonte:</b> Amanda, Arthur e Cauã</p>
</details>
...
<details style="margin-bottom: 20px;">
    ...
    <p style="text-align: center;"><img src="../assets/design_sprint/prototipo/telainicial.png" style="max-width: 100%; height: auto; margin-top: 10px;" /></p>
</details>
...
<details style="margin-bottom: 20px;">
    ...
    <p style="text-align: center;"><img src="../assets/design_sprint/prototipo/telacadastro.png" style="max-width: 100%; height: auto; margin-top: 10px;" /></p>
</details>
...
<details style="margin-bottom: 20px;">
    ...
    <p style="text-align: center;"><img src="../assets/design_sprint/prototipo/telalogin.png" style="max-width: 100%; height: auto; margin-top: 10px;" /></p>
</details>
...
<details style="margin-bottom: 20px;">
    ...
    <p style="text-align: center;"><img src="../assets/design_sprint/prototipo/telaprincipal.png" style="max-width: 100%; height: auto; margin-top: 10px;" /></p>
</details>
...
<details style="margin-bottom: 20px;">
    <summary><strong>Protótipo: Tela principal e encontrar caronas</strong></summary>
    <p style="text-align: center;"><img src="../assets/design_sprint/prototipo/modalconfirmacao.png" style="max-width: 100%; height: auto; margin-top: 10px;" /></p>
</details>
...
<details style="margin-bottom: 20px;">
    ...
    <p style="text-align: center;"><img src="../assets/design_sprint/prototipo/telaoferecer.png" style="max-width: 100%; height: auto; margin-top: 10px;" /></p>
</details>


- **Tela 6: Minhas viagens (Caronas utilizadas) - Usuário logado**
    - ***Descrição:*** Histórico do passageiro (aba ativa). Cartão Detalhes com motorista (foto/nome), veículo/vagas, Avaliação (estrelas/nota), itinerário (data/horas, origem→destino), duração e preço, além de Enviar mensagem. Lista abaixo resume outras viagens com motorista, data e valor. Rodapé padrão, Minhas viagens ativo.
    - ***Observações:*** Nenhuma por enquanto.
<details style="margin-bottom: 20px;">
    <summary><strong>Protótipo: Tela de oferecer caronas</strong></summary>
    <p style="text-align: center;"><img src="../assets/design_sprint/prototipo/telaminhasviagens1.png" style="max-width: 100%; height: auto; margin-top: 10px;" /></p>
</details>


- **Tela 7: Minhas viagens (Caronas realizadas) - Usuário logado**
    - ***Descrição:*** Histórico do motorista (aba ativa). Cartão Detalhes do passageiro destaca a última corrida: rótulo Passageiro, nome, valor e itinerário (data/horas, origem→destino). Demais cartões listam outros passageiros com data e valor. Rodapé padrão, Minhas viagens ativo.
    - ***Observações:*** Nenhuma por enquanto.
<details style="margin-bottom: 20px;">
    <summary><strong>Protótipo: Tela de oferecer caronas</strong></summary>
    <p style="text-align: center;"><img src="../assets/design_sprint/prototipo/telaminhasviagens2.png" style="max-width: 100%; height: auto; margin-top: 10px;" /></p>
</details>
...
<details style="margin-bottom: 20px;">
    <summary><strong>Protótipo: Tela de oferecer caronas</strong></summary>
    <p style="text-align: center;"><img src="../assets/design_sprint/prototipo/telaperfil.png" style="max-width: 100%; height: auto; margin-top: 10px;" /></p>
</details>
